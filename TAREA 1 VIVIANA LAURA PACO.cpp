// PROGRAMA TAREA 1        fecha : 15/03/22
...
void MenuOperacionesMatriciales(Matriz & A, Matriz & B, Matriz & C){
	...
	do{
		...
		cout <<"|					                       " << endl
			...
			<< "|	1. Suma A+B				               " 	<< endl 
			<< "|	2. Resta A-B				           "	<< endl 
			<< "|	3. Multiplicacion A*B				   "		<< endl 
			<< "|	4. Matriz elevada A^x				   "	<< endl 
			<< "|	5. Multiplicacion por unj escalar A.x  "		<< endl 
			<< "|	6. Matriz transpuesta Trn(A)		   "		<< endl 
			<< "|	7. Determinante |A|				      "		<< endl
			<< "|	8. Matriz Adjunta Adj(A)			   "		<< endl
			<< "|	9. Matriz inversa A^-1				   "		<< endl
			<< "|	0. Volver		                       "		<< endl
			<< "|					                      " << endl
